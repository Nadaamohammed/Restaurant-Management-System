...
public static class OrderUI
{
    ...
    private static void PlaceOrder()
    {
        ...
        var (success, msg, orderId) = OrderService.PlaceOrder(empId, custId, branchId, orderType, deliveryAddr, items);
        if (success) ConsoleHelper.Success($"{msg}  Order ID: #{orderId}");
